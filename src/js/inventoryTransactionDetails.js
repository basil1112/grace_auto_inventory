            ...
            if(err) {
                ...
                for(let key in transactions) {
                    ...
                    resultHTML += `<tr class="clickable transactionRow" id="row_${transactions[key].id}">
                                        ...
                                        <td class="text-right">${(issues ? commonModule.uomFormat(issues, uom)+''+tempValue : '')}</td>
                                        <td class="text-right">${commonModule.uomFormat(closingStock, uom)}</td>
                                        <td class="text-right">${(receipts ? receipts * transactions[key].unitValue : '')}</td>
                                        <td class="text-right">${(issues ? issues * transactions[key].unitValue : '')}</td>
                ...
                resultHTML += `<tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="text-right"><b style="color:blue">${commonModule.uomFormat(closingStock, uom)}</b></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
